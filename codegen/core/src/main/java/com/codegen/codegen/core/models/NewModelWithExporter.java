 ...
 * #L%
 */
package com.codegen.codegen.core.models;
...
@Component(value = "NewModelWithExporter")
@Model(
        ...
        resourceType = "codegen/components/content/newmodelwithexporter",
 ...
 */
public class NewModelWithExporter {
    ...
    @Inject @Optional
    @DialogField(fieldLabel="pageTitle")
    @TextField
    private String pageTitle;
    @DialogField(fieldLabel="OptionalTitle")
    @TextField
    // Mark as Optional
    @Inject @Optional    
...
/*    	System.out.println("Resource Type" + resource.getResourceType());        
    	System.out.println("Resource path" + resource.getResourceMetadata());
    	
    	page = resourceResolver.adaptTo(PageManager.class).getContainingPage(resource);
    	System.out.println("Page Type" + page.getName());
